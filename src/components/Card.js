...
const Card = ({ icon, title, description, margin }) => {
  return (
    <div className='group mt-5'>
      <div className={`p-3  cardCategory bg-white text-black rounded-md shadow-md cursor-default  transition-all duration-500 group-hover:bg-greenBg group-hover:text-white`}>
