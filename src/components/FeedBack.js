    ...
    <section id="feedback">
      <div className="xl:container mx-auto px-12 mt-32">
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-x-4 ">
          <div>
            <h2 className="text-3xl font-bold text-center order-1 md:text-left">
              People's Feedback about JobNow!
            </h2>

            <div className=" py-6 text-gray-600 text-center  order-2 md:text-left">
            ...
            <div className=" py-6 font-bold  text-center order-3 md:text-left">
              <p className="lg:pr-10 2xl:pr-28">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed,
                officia maiores? Voluptates beatae ipsam tenetur cupiditate
                iusto consequuntur natus quam autem. Voluptate dignissimos iusto
            ...
            <div className="text-center pt-8 order-5 md:text-left">
