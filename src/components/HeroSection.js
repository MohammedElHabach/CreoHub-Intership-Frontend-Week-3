  ...
  return (
    <section id='hero' className='' >
        ...
        <div className='bg-greenBg mt-12 py-52 md:hidden'>
            ...
            <SignalCellularAltIcon sx={{color:"white",fontSize:"5rem",position:"absolute",top:"50rem",left:"7%",transform: 'rotate(5deg)'}}/>
            <SecurityIcon sx={{color:"white",fontSize:"5rem",position:"absolute",top:"40rem",left:"70%",transform: 'rotate(5deg)'}}/> <br /> 
        </div>

        <div className='hidden md:block'>
            <SearchIcon sx={{color:"white",fontSize:"5rem",position:"absolute",top:"15%",left:"70%"}}/>
            <SignalCellularAltIcon sx={{color:"white",fontSize:"5rem",position:"absolute",top:"27%",left:"90%",transform: 'rotate(5deg)'}}/>
            <SecurityIcon sx={{color:"white",fontSize:"5rem",position:"absolute",top:"35%",left:"67%",transform: 'rotate(5deg)'}}/> <br /> 
        </div>
